        ...
        axios.post(`${API}/verifyOtp/${mail}/${otp}`)
            .then(res => {
                ...
                setUser(
                    ...
                    .catch(err => setMessage("Email not registered"))
                );
                ...
                <div className="container" style={{marginTop:"5vh"}}>
                    <form onSubmit={handleReset}>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="input-group">
                                ...
                                <button
                                    ...
                                    onClick={sendOtp}
                                    disabled={otpSent || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(mail)}
                                    >
                        ...
                        <div className="mb-3">
                            ...
                            {newPassword.confirmPass.length > 0 && (newPassword.confirmPass.length < 8 || newPassword.newPass.length > 16) && (
                                <small className="text-danger">
                                Password must be 8 to 16 characters
                                </small>
                            )}
